...
def main():
    ...
    if args.log_level != config.log_level:
        config = HindsightConfig(
            ...
            primary_llm_enabled=config.primary_llm_enabled,
            primary_llm_provider=config.primary_llm_provider,
            primary_llm_model=config.primary_llm_model,
            primary_llm_api_key=config.primary_llm_api_key,
            primary_llm_base_url=config.primary_llm_base_url,
            primary_llm_failure_threshold=config.primary_llm_failure_threshold,
            primary_llm_cooldown_seconds=config.primary_llm_cooldown_seconds,
