...
import { stripMarkdown, deduplicateByJaccard, formatMemoriesCompact } from "./memory-formatter.js";
...
describe("stripMarkdown", () => {
  ...
  it("removes bold markers", () => {
    expect(stripMarkdown("**Key point**: Igor is CTO")).toBe("Key point: Igor is CTO");
  ...
  it("removes inline code backticks", () => {
    expect(stripMarkdown("Use `console.log` for debug")).toBe("Use console.log for debug");
  });
